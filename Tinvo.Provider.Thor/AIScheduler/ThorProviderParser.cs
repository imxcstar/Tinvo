...
using Tinvo.Provider.Thor.API;

namespace Tinvo.Provider.Thor.AIScheduler
{
    public class ThorProviderParser : IAIChatParser
    {
        ...
        public ThorProviderParser()
        {
            _logger = Log.ForContext<ThorProviderParser>();
        }
